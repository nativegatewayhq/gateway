...
integration-test:
	...
	TEST_DATABASE_URL="$$TEST_DATABASE_URL" TEST_REDIS_URL="$$TEST_REDIS_URL" go test -race -count=1 -tags=integration ./internal/database ./internal/apikey ./internal/billing ./internal/costquota ./internal/imagestorage ./internal/jobs ./internal/ledger ./internal/pricing ./internal/providercredentials ./internal/providerhealth ./internal/ratelimit ./internal/reconciliation ./internal/spendcap ./protocols/gemini ./protocols/openai ./protocols/replicate ./providers/google ./providers/openai ./providers/replicate ./providers/xai ./cmd/gateway-key ./cmd/gateway-quota ./cmd/gateway-spend-cap ./cmd/gateway-provider-credential ./cmd/gateway
