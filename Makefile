...
integration-test:
	...
	TEST_DATABASE_URL="$$TEST_DATABASE_URL" TEST_REDIS_URL="$$TEST_REDIS_URL" go test -race -count=1 -tags=integration ./internal/database ./internal/apikey ./internal/billing ./internal/chatbilling ./internal/chatpricing ./internal/chatreconciliation ./internal/costquota ./internal/imagestorage ./internal/jobs ./internal/ledger ./internal/pricing ./internal/providercredentials ./internal/providerhealth ./internal/ratelimit ./internal/reconciliation ./internal/spendcap ./protocols/anthropic ./protocols/fal ./protocols/gemini ./protocols/openai ./protocols/replicate ./providers/anthropic ./providers/fal ./providers/google ./providers/openai ./providers/replicate ./providers/xai ./cmd/gateway-chat-price ./cmd/gateway-key ./cmd/gateway-quota ./cmd/gateway-spend-cap ./cmd/gateway-provider-credential ./cmd/gateway
