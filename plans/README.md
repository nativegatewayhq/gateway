...
| `gateway-20260821-046` | proposed | [Phase 4 Anthropic Messages Token Usage Billing and Settlement](./20260821_233000_plan_phase4_anthropic_token_usage_settlement.md) | `phase-4-anthropic-token-usage-settlement` |
