...
| `gateway-20260823-054` | completed | [Phase 5 OpenAI Audio Speech Native Foundation](./20260823_003000_plan_phase5_openai_audio_speech_foundation.md) | `phase-5-openai-audio-speech-foundation` |
| `gateway-20260823-055` | completed | [Phase 5 OpenAI Speech Character Pricing and Settlement](./20260823_043000_plan_phase5_openai_speech_billing_settlement.md) | `phase-5-openai-speech-billing-settlement` |
...
| `gateway-20260824-059` | completed | [Phase 5 OpenAI Audio Translation Duration Pricing and Settlement](./20260824_130934_plan_phase5_openai_audio_translation_billing_settlement.md) | `phase-5-openai-audio-translation-billing-settlement` |
| `gateway-20260824-060` | completed | [Phase 5 Managed Audio Input Assets and Reusable References](./20260824_133500_plan_phase5_managed_audio_input_assets.md) | `phase-5-managed-audio-input-assets` |
...
| `gateway-20260824-066` | completed | [Phase 6 Async Video Plugin Runtime, Runway Native Projection, and Managed Delivery](./20260824_182359_plan_phase6_async_video_plugin_runway_projection.md) | `phase-6-async-video-plugin-runtime` |
