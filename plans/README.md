...
| `gateway-20260822-049` | accepted | [Phase 4 OpenAI Responses Protocol-compatible Provider Routing](./20260822_070000_plan_phase4_openai_responses_provider_routing.md) | `phase-4-openai-responses-provider-routing` |
