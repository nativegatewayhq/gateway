...
| `gateway-20260821-041` | accepted | [Phase 4 OpenAI Responses SSE Streaming and Disconnect Settlement](./20260821_123000_plan_phase4_openai_responses_streaming_settlement.md) | `phase-4-openai-responses-streaming-settlement` |
