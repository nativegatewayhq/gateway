...
var ErrInvalid = errors.New("invalid plugin async envelope")

func DecodeSubmitRequest(reader io.Reader, maximum int64) (SubmitRequest, error) {
	var value SubmitRequest
	if decode(reader, maximum, &value) != nil || ValidateSubmitRequest(value) != nil {
...
func CanonicalSubmitRequest(value SubmitRequest) ([]byte, error) {
	if ValidateSubmitRequest(value) != nil {
