...
func validDimension(protocol, operation, model string) bool {
	...
	return ((protocol == "openai" && (operation == "image.generate" || operation == "image.edit" || operation == "chat.completions" || operation == "responses.create")) || (protocol == "gemini" && (operation == "image.generate" || operation == "chat.completions")) || ((protocol == "replicate" || protocol == "fal") && operation == "image.generate")) && validText(model, 200)
}
