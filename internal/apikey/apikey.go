...
func validModelPermission(permission ModelPermission) bool {
	...
	return (permission.Protocol == "openai" && (permission.Operation == "image.generate" || permission.Operation == "image.edit" || permission.Operation == "chat.completions" || permission.Operation == "responses.create" || permission.Operation == "audio.speech")) ||
		(permission.Protocol == "gemini" && (permission.Operation == "image.generate" || permission.Operation == "chat.completions")) ||
		((permission.Protocol == "replicate" || permission.Protocol == "fal") && permission.Operation == "image.generate") ||
		(permission.Protocol == "anthropic" && permission.Operation == "messages.create") ||
		(permission.Protocol == "runway" && permission.Operation == "video.generate")
}
